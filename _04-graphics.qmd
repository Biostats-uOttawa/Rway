...
One gig advantage of `ggplot` for simple scatterplot is the ease with which we can add a regression, smoother (loes or gam) line to the plot using `geom_smooth()`function to add a statistic layer to the plot.
