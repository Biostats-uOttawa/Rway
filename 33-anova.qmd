...
::: callout-warning
Double check that the independent variable is a **factor**. If the independent variable is a **character**, then you will obtain only 3 graphs and an error message like:
...
This is better. Also useful is to plot the means and their confidence intervals with the Tukey groupings shown as letters above:
...
Version `lmPerm` for permutation test.
