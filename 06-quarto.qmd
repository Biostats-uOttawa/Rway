...
Now, to convert your `.qmd` file to a HTML document click on the little black triangle next to the `Knit` icon at the top of the source window and select `render to HTML`  
...
If you want to render your `.qmd` file to a pdf document then all you need to do is choose `render to PDF` instead of `render to HTML` when you click on the `knit` icon.
